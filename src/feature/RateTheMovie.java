...
public final class RateTheMovie {
     ...
     * @param database
     */
    public static void rate(final ActionsInputData command,
        ...
        if (LiveInfo.getInstance().getCurrentPage().getPageType().equals("see details")) {
             ...
             */
            if (command.getRate() <= Constants.RATE_LIMIT) {
                ...
                for (int k = 0; k < LiveInfo.getInstance().getCurrentUser()
                    ...
                    if (LiveInfo.getInstance().getCurrentUser().getWatchedMovies()
                        ...
                        ratedMovie.setRating(ratedMovie
                                .getSumOfRating() / ratedMovie.getNumRatings());
                        ...
                        objectNode.putPOJO("currentMoviesList",
                                new ArrayList<>(Collections.singleton(ratedMovie)));
